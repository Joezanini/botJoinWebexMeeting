...
/*
Code is based on https://github.com/Clubfan22/half-that-army-was-halluc
*/
const username = "Join Bot";
const iss = 'YOUR GUEST ISSUER ID'
const secret = 'YOUR SHARED SECRET'
const meetingUrl = 'URL OF MEETING TO JOIN'
